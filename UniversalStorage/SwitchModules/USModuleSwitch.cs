...
namespace UniversalStorage2
{
  ...
  {
    [KSPField] public string TargetModule = string.Empty;
    [KSPField] public string TargetFields = string.Empty;
    [KSPField] public string TargetValues = string.Empty;
    [KSPField] public bool EarlyApply = false;
