...
namespace UniversalStorage2
{
  public class USRadiatorSwitch : ModuleActiveRadiator
  {
    ...
    [KSPField] public string RadiatorAvailable = string.Empty;
    [KSPField] public string RadiatorPower = string.Empty;
    [KSPField] public string RadiatorOvercool = string.Empty;
    [KSPField] public string RadiatorEnergy = string.Empty;
    [KSPField] public bool ManualRadiatorToggle = false;
    [KSPField(isPersistant = true)] public bool ActiveCooling = true;
    ...
    [KSPEvent(guiName = "#autoLOC_6001416", active = false, guiActive = true, guiActiveEditor = true,
      guiActiveUnfocused = true, unfocusedRange = 4f, externalToEVAOnly = true)]
    ...
    private void UpdateRadiator()
    {
      ...
      {
        var i = _RadiatorAvailables[CurrentSelection];
