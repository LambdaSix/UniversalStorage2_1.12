...
namespace UniversalStorage2
{
  ...
  {
    [KSPField] public string DecoupleAnimationName;
    [KSPField] public float DecoupleTime = -1;
    [KSPField] public bool DecoupleEVA = true;
    [KSPField] public float AnimationSpeed = 1;
    ...
    private IEnumerator WaitForDecouple()
    {
      ...
      for (var i = _decoupleAnimation.Length - 1; i >= 0; i--)
      {
        var anim = _decoupleAnimation[i];
